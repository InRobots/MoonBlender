...
def train(cfg_dict: DictConfig):
    ...
    if cfg.mode == "train" and checkpoint_path is not None and not cfg.checkpointing.resume:
        ...
        print(cyan(f"Init weigths."))
        
        ckpt = torch.load("checkpoints/DUSt3R_ViTLarge_BaseDecoder_512_dpt.pth", map_location="cpu")
        print(cyan(f"Loading pretrained: checkpoints/DUSt3R_ViTLarge_BaseDecoder_512_dpt.pth"))
        print(cyan(model_wrapper.encoder.model.load_state_dict(ckpt['model'], strict=True)))
