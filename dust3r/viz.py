    ...
    def add_cameras(self, poses, focals=None, images=None, imsizes=None, colors=None, **kw):
        ...
        for i, pose_c2w in enumerate(poses):
            ...
            if color is not None:
                self.add_camera(pose_c2w, get(focals,i), image=get(images,i), color=color, imsize=get(imsizes,i), **kw)
            else:
                self.add_camera(pose_c2w, get(focals,i), image=get(images,i), imsize=get(imsizes,i), **kw)
        return self
